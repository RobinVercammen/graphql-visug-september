...
namespace GraphQL.Api.Controllers
{
	...
	public class GraphqlController : Controller
	{
		...
		{
			return PostAsync(new GraphQLQuery { Query = "query foo { hero }", Variables = "" });
		}

		[HttpPost]
		public async Task<ActionResult> PostAsync([FromBody]dynamic q)
		{
			var s = JsonConvert.SerializeObject(q);

			GraphQLQuery query = JsonConvert.DeserializeObject<GraphQLQuery>(s);
